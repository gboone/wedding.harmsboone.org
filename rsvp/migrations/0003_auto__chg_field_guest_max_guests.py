...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Guest.max_guests'
        db.alter_column(u'rsvp_guest', 'max_guests', self.gf('django.db.models.fields.IntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'Guest.max_guests'
        db.alter_column(u'rsvp_guest', 'max_guests', self.gf('django.db.models.fields.IntegerField')(default=2))
